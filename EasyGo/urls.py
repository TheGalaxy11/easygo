...
urlpatterns = [
     ...
     path("updatePassword/<str:staffID>", views.updatePassword, name="updatePassword"),
     path("updatePassword/save_update_password/<str:staffID>", views.save_update_password, name="save_update_password"),
